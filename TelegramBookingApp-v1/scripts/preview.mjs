...
(() => {
  ...
  addEventListener('DOMContentLoaded',()=>{
    ...
    badge.style.cssText='position:fixed;top:0;left:0;right:0;height:20px;display:flex;align-items:center;justify-content:center;z-index:2147483647;pointer-events:none;background:#dce7de;color:#345041;font:9px/1.1 system-ui;letter-spacing:1px';
...
function wrapper() {
  ...
  *{box-sizing:border-box}body{margin:0;min-height:100vh;background:#e8eae8;color:#25362b;font:14px/1.5 system-ui;display:flex;gap:48px;justify-content:center;align-items:flex-start;padding:28px}aside{width:230px;padding-top:30px}h1{font-size:26px;letter-spacing:-1px;line-height:1.2;margin:0 0 12px}p{color:#667169}button,a{display:block;width:100%;border:1px solid #c8d0c8;border-radius:12px;padding:10px 14px;background:#f8faf7;margin:8px 0;color:#273d30;text-decoration:none;font:inherit;text-align:left;cursor:pointer}button:hover,a:hover{background:white}small{display:block;color:#6f7e71;margin-top:24px}iframe{display:block;width:390px;height:844px;border:0;border-radius:34px;background:#fff;box-shadow:0 20px 80px #1c322321;outline:7px solid #233329}.phone{margin:8px 0 24px}@media(max-width:760px){body{padding:18px;display:block}aside{width:min(390px,100%);padding:0;margin:0 auto 20px}aside p,aside small{display:none}aside .controls{display:flex;gap:5px;flex-wrap:wrap}button,a{width:auto;flex:1;font-size:12px;padding:8px}.phone{width:390px;max-width:100%;margin:0 auto}iframe{max-width:100%;height:844px;border-radius:24px}}
